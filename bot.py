...
async def on_ready():
    ...
    watch = ['за клоунами', 'українські новини', ', но не здоровается']
    listen = ['гімн України', 'пропаганду', 'власть', ', но не слышит']
    games = ['войнушки', 'симмулятор козла']
    stream = ['пропаганду', ', но не Бустер']
    while True:
