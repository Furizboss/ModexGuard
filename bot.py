...
async def on_ready():
    ...
    watch = ['гей порно', 'за клоунами', 'українські новини',
             'хентай', 'секс оргию', ', но не здоровается']
    listen = ['хуйню', 'пердёж', 'молитвы', 'гімн України',
              'пропаганду', 'власть', ', но не слышит']
    games = ['ролевые игры', 'войнушки', 'теракт 911',
             'взрыв жопы', 'симмулятор козла', 'игры с дружком']
    stream = ['пропаганду', 'порнуху 24/7',
              'Onlyfans', 'ебанину', ', но не Бустер']
    while True:
